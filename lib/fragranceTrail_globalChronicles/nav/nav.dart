      ...
      routes: [
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            olfactoryBazaarExpedition: params.getParam(
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            spiceHeritageWanderlustID: params.getParam(
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            sensoryBazaarOdysseyMap: params.getParam(
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            bazaarOlfactoryExperienceVault: params.getParam(
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            magicalVoyageStorytellingArenaChat: params.getParam(
              'magicalVoyageStorytellingArenaChat',
              ParamType.int,
            ),
            scenicExplorationJourneyUserid: params.getParam(
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            scentInspiredCulturalQuest: params.getParam(
              'scentInspiredCulturalQuest',
              ParamType.int,
            ),
          ),
        ),
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            culturalDiscoveryJournalPlace: params.getParam(
        ...
        JourneyAcrossFragrantBazaars(
          ...
          builder: (context, params) =>
            ...
            inspiringVoyageExperienceBoard: params.getParam(
